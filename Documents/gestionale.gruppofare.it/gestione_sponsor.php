...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['sponsor_img'])) {
    ...
    if (empty($name)) {
        ...
        if (move_uploaded_file($file['tmp_name'], $dest)) {
            ...
            $message = 'Sponsor "' . htmlspecialchars($name) . '" aggiunto ' . $quantita . ' volte!';
...
<div class="page-wrap">
    ...
    <div class="panel">
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label class="form-label fw-semibold" style="font-size:.9rem;">Quante volte mostrare</label>
                <input type="number" name="quantita" class="form-control" value="1" min="1" max="10" 
                       style="border-radius:10px;border-color:rgba(82,82,81,0.2);padding:10px 14px;">
                <small style="color:#666;font-size:0.8rem;">1 = mostra una volta, 5 = mostra 5 volte nella gallery</small>
            </div>
