...
$show_ren_richieste = in_array($ruolo_utente, ['admin', 'backoffice', 'agente', 'capoarea']);
...
<div class="content-container">
    <div class="menu-card">
        ...
        <div class="menu-grid <?= ($ruolo_utente === 'installatore') ? 'single-card' : '' ?>">
            ...
            <a href="ren/elenco_richieste.php" class="menu-item">
                <i class="fas fa-solar-panel" style="color: #20c997;"></i>
                <h4>Richieste REN</h4>
                <p>Elenco e gestione richieste Bonus Ren</p>
            </a>
            <?php elseif (in_array($ruolo_utente, ['agente', 'capoarea'])): ?>
            <a href="ren/nuova_richiesta.php" class="menu-item">
                <i class="fas fa-solar-panel" style="color: #20c997;"></i>
                <h4>Richiesta REN</h4>
                <p>Inserisci nuova richiesta Bonus Ren</p>
            </a>
            <?php endif; ?>
