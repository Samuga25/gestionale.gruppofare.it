    ...
    <div class="panel">
        ...
        <div class="sponsor-grid" id="sponsorGrid">
            ...
            <div class="sponsor-card" draggable="true" data-id="<?= htmlspecialchars($sp['id']) ?>">
                ...
                <button type="button" class="btn-edit" onclick="openEditModal('<?= htmlspecialchars($sp['id']) ?>', '<?= addslashes(htmlspecialchars($sp['name'])) ?>', '<?= addslashes(htmlspecialchars($sp['badge_testo'] ?? '')) ?>')">
...
function openEditModal(id, name, badge) {
