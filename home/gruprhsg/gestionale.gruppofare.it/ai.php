...
.header-logo-img {
    ...
    object-fit: contain;  /* ← aggiungi questa riga */
}
...
.page-header-icon {
    ...
    border-radius: 16px;  /* ← opzionale, arrotonda gli angoli */
}
...
<body>
    ...
    <header class="main-header">
        <div class="header-container">
            <a href="area_riservata.php" class="header-logo">
                ...
                <span class="header-logo-text">Fare AI</span>
            </a>
    ...
    <div class="sections-container">
        <div class="sections-grid">
            <!-- CARTELLA DRIVE -->
            <a href="drive_link.php?folder=FareAI&view=my_files" class="section-card">
                <i class="fas fa-folder-open"></i>
                <h3 class="section-title"> Cartella Drive</h3>
                <p class="section-desc">
                    Accedi ai documenti e file dell'area Fare AI
                </p>
